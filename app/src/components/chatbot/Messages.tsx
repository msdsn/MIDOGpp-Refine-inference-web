...
import { ChatBubbleAvatar, CodeViewActions } from './common-components';
import { AUTHORS, fileTokenGroupI18nStrings, type Message, supportPromptItems } from './config';
...
export default function Messages({
  ...
  return (
    <div className="messages" role="region" aria-label="Chat" style={{ padding: '12px' }}>
      ...
      {messages.map((message, index) => {
        ...
        return (
          <SpaceBetween size="xs" key={message.authorId + message.timestamp + index}>
            <ChatBubble
